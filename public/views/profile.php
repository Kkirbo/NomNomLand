...
$canResetPassword=isset($_SESSION['password_reset_user']) && $_SESSION['password_reset_user'] === $user['id'];
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<?php if($canResetPassword): ?>
  ...
  <div class="password-field">
    ...
    <input id="password"maxlength="100"name="password"type="password"placeholder="New password"class="editable-password">
  </div>
<?php endif; ?>
</div>

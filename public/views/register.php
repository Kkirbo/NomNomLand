...
<body>
  ...
  <main>
    <form method="post" novalidate class="validateForm modernNeonBox">
      <div class="field">
          <label for="name">Last Name:</label>
          <input id="name" class="autoformat" name="name" type="text" placeholder="Last Name" required value="<?= retype('name')  ?>">
        </div>
      <div class="field">
          <label for="firstname">First name:</label>
          <input id="firstname" class="autoformat" name="firstname" type="text" placeholder="First Name" required value="<?= retype('firstname') ?>">
      </div>
      <div class="field">

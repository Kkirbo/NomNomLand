        ...
        <fieldset class="modernNeonBox">
            ...
            <div class="field">
                ...
                <div class="password-field">
                  <input type="checkbox" name="togglePassword">
